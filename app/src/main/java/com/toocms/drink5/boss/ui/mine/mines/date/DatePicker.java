...
public class DatePicker extends WheelPicker {
    ...
    private int findItemIndex(ArrayList<String> items, int item) {
        //折半查找有序元素的索引
//        int index = Collections.binarySearch(items, DateUtils.fillZero(item));
    ...
    protected View makeCenterView() {
        ...
        yearTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSize(textSize));
...
//        monthTextView.setTextSize(textSize);
        monthTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSize(textSize));
        ...
        dayTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSize(textSize));
