package com.toocms.drink5.boss.ui.mine.mines.date.popup;
...
import com.toocms.drink5.boss.ui.mine.mines.date.util.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected CharSequence titleText = "暂不支持顺带";
    protected int cancelTextColor = 0xff2c82df;
    protected int submitTextColor = 0xff2c82df;
    protected int titleTextColor = 0xffffffff;
    ...
    public void setTitlelVisible(boolean titleVisible) {
    ...
    protected View makeHeaderView() {
        ...
        topButtonLayout.setLayoutParams(new RelativeLayout.LayoutParams(MATCH_PARENT, AutoUtils.getPercentHeightSize(88)));
        topButtonLayout.setBackgroundColor(0xffeeeeee);
        ...
        if (!TextUtils.isEmpty(cancelText)) {
            ...
            cancelButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSize(28));
        }
        ...
        RelativeLayout.LayoutParams titleLayoutParams = new RelativeLayout.LayoutParams(AutoUtils.getPercentWidthSize(210), AutoUtils.getPercentHeightSize(58));
        ...
        titleView.setBackgroundResource(R.drawable.shape_date_top);
        if (!TextUtils.isEmpty(titleText)) {
            titleView.setText(titleText);
        }
        titleView.setTextColor(titleTextColor);
        titleView.setTextSize(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSize(28));
        ...
        if (!TextUtils.isEmpty(submitText)) {
            ...
            submitButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSize(28));
        }
