 ...
 * @date 2016/6/7 16:36
 */
public class Student2Aty extends BaseAty {
...
//        list.add(llD);
    ...
    protected void requestData() {
        showProgressContent();
        contact.isColleague(application.getUserInfo().get("c_id"), 1, this);
    }
...
//        mLocClient.start();
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                View view = View.inflate(Student2Aty.this, R.layout.map_stu, null);
                ...
                imgv_phone.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!TextUtils.isEmpty(phone)) {
                            Student2Aty.this.callPhone(phone);
                        }
                    }
                });
                for (int i = 0; i < list2.size(); i++) {
                    if (marker == list2.get(i)) {
                        ...
                        tv_tong.setText(maps.get(i).get("num"));
                        tv_piao.setText(maps.get(i).get("ticket"));
                        tv_hu.setText(maps.get(i).get("mem"));
    ...
    private void ada() {
        ...
        PendingIntent sender = PendingIntent.getBroadcast(Student2Aty.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        long firstime = SystemClock.elapsedRealtime();
        AlarmManager am = (AlarmManager) Student2Aty.this.getSystemService(ALARM_SERVICE);
        //5秒一个周期，不停的发送广播
        am.cancel(sender);
...
//                list2.get(i).setPosition(llNew);
//            }
            contact.isColleague(application.getUserInfo().get("c_id"), 1, Student2Aty.this);
