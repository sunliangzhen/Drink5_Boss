...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		LinearLayout.LayoutParams paramsView2 = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, AutoUtils.getPercentHeightSize(30), TypedValue.COMPLEX_UNIT_PX);
		llPage.addView(view2, paramsView2);

		View view = new View(activity);
		view.setBackgroundColor(0xffdbdbdb);
		LinearLayout.LayoutParams paramsView = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, AutoUtils.getPercentHeightSize(1),TypedValue.COMPLEX_UNIT_PX);
		llPage.addView(view, paramsView);
		/**
		 * sun`
		 */
		...
		textView.setText("取消");
		int heigth = AutoUtils.getPercentHeightSize(60);
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,heigth,TypedValue.COMPLEX_UNIT_PX);
		textView.setTextColor(0xff3b6ebf);
		...
		textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSize(28));
		llPage.addView(textView, params);
